...
<div id="container">
    ...
    <?php
        ...
        echo "</br><button type='submit' id='addNewExtra' name='addNewExtra'>Add</button>";
        echo "</form>";
    ?>
    <hr>
</div>
...
if(isset($_POST['addNewExra'])) {
    // Get the Name of the row to be added
    $extraToAdd = key($_POST['newExtraName']);
    // sql to select
    ...
    if ($result_select) {
        ...
        // sql to add
        $extraName = $_POST['newExtraName'];
        $extraPrice = $_POST['newExtraPrice'];
        $sql_add = "INSERT INTO extra_list (ExtraName, ExtraPrice) VALUES ($extraName, $extraPrice)";
        // if adds, good
